              ...
              <>
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-popover rounded-md shadow-lg py-1 z-20 border border-border">
                    <Link
                      href="/profile"
                      className="block px-4 py-2 text-sm text-popover-foreground hover:bg-secondary hover:text-secondary-foreground"
                    >
                      Profile
                    </Link>
                    <Link
                    ...
                    <button
                      ...
                      className="block w-full text-left px-4 py-2 text-sm text-popover-foreground hover:bg-secondary hover:text-accent-foreground"
                    >
                      Logout
                    </button>
                  </div>
