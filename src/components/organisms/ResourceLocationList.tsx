...
const ResourceLocationList: React.FC<ResourceLocationListProps> = ({
  locations,
}) => {
  return (
        ...
        >
          ...
          >
            ...
            <div className="flex-1 min-w-0 py-2">
              <h2 className="font-extrabold text-xl text-foreground mb-1 drop-shadow-sm">
                {location.name}
              </h2>
              {location.subtitle && (
                <div className="text-primary text-sm mb-1 font-medium">
                  {location.subtitle}
                </div>
              )}
