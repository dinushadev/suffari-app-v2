...
const BookingHistoryPage = () => {
  ...
  const bookingsToDisplay = (allBookingsData?.data || [])
    .map((booking) => ({
      ...booking,
      status:
        booking.status === "upcoming"
          ...
          ? "confirmed"
          : booking.status,
      startTime: `${booking.schedule.date}T${
        booking.schedule.timeSlot === "morning"
          ? "06:00:00"
          : booking.schedule.timeSlot === "night"
          ? "18:00:00"
          : "12:00:00"
      }`,
      endTime: `${booking.schedule.date}T${
        booking.schedule.timeSlot === "morning"
          ? "12:00:00"
          : booking.schedule.timeSlot === "night"
          ? "23:59:59"
