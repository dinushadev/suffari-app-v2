...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center bg-background p-4">
      ...
      <p
        className="mb-8 text-base sm:text-lg text-foreground font-medium text-center max-w-xl drop-shadow-sm flex items-center justify-center gap-2"
      ...
      {/* <p className="mb-8 text-lg sm:text-xl text-foreground font-medium text-center max-w-xl drop-shadow-sm flex items-center justify-center gap-2">
        ...
        <svg
          ...
          className="lucide lucide-flame w-4 h-4 text-primary hover:text-secondary transition-colors duration-300 cursor-pointer"
          aria-hidden="true"
        >
